...
> **💡 Note:** Examples below use curl for demonstration. For production pipelines, use the [`bldst` CLI tool](cli/README.md) for cleaner, more maintainable code.
...
- **Design Document**: [Resumable Builds Design](resumable-builds-design.md)
