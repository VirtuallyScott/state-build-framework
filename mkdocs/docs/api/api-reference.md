...
> **💡 Recommended for Pipelines:** Use the [`bldst` CLI tool](../cli/README.md) for cleaner, more maintainable pipeline code. See [README.md](README.md) for CLI examples.
>
...
> 📖 For detailed information on artifact storage tracking, see [Artifact Storage Tracking](../artifact-storage.md).
...
> - [Artifact Storage Tracking](../artifact-storage.md)
