...
- [Deployment Guide](api/README.md) - Production setup
...
**Documentation:**
- [CLI Documentation](cli/README.md) - Complete reference
- [Quick Start Guide](cli/quickstart.md) - 5-minute guide
- [Usage Examples](cli/README.md#usage-examples) - Common workflows
...
**Documentation:**
- [Problem Statement](problem-statement.md) - Why this framework exists and how it helps
- [Artifact Storage](artifact-storage.md) - Distributed artifact tracking
...
### API Documentation
- **[API Reference](api/api-reference.md)** - All endpoints, request/response schemas, examples
- **[Authentication Guide](api/authentication.md)** - JWT tokens, API keys, scopes, best practices
- **[Architecture Overview](api/architecture.md)** - System design, scaling, database
- **[Deployment Guide](api/README.md)** - Production deployment, Docker, configuration

### CLI Documentation
- **[CLI Documentation](cli/README.md)** - Complete command reference
- **[Quick Start Guide](cli/quickstart.md)** - Get started fast
- **[API Integration](cli/README.md#cicd-integration)** - CI/CD examples

### Framework Documentation
- **[Problem Statement](problem-statement.md)** - Why this framework exists and how it solves the problems
- **[Artifact Storage](artifact-storage.md)** - Distributed build artifact tracking
- **[Database Architecture](database-architecture.md)** - Data model and schema design

### CI/CD & DevOps
- **[CI/CD Pipeline](ci-cd-pipeline.md)** - Automated builds, semantic versioning, container registry
- **[Resumable Builds Design](resumable-builds-design.md)** - Advanced resumability architecture
...
See [Problem Statement](problem-statement.md) for complete framework documentation.
...
See [Deployment Guide](api/README.md) for:
...
- **API Issues**: Check [API Reference](api/api-reference.md) and [Authentication Guide](api/authentication.md)
- **CLI Issues**: Check [CLI Documentation](cli/README.md)
- **Framework Questions**: See [Problem Statement](problem-statement.md)
